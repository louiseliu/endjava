...
//			console.log(ms);
		...
		var ifBegins = 0;//unfinished,support complex expression
		if (ms = page.match(/\<c\:if.*\>/ig))//types:1 x>2;2 y > x;3 x;4 x==='test';
		{
			for(i=0; m=ms[i]; i++)
			{
